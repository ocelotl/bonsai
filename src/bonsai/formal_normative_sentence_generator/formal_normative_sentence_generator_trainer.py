...
formal_normative_sentence_generator_path = Path(
    "/content/drive/My Drive/bonsai/"
    f"formal_normative_sentence_generator/{verb}"
)
...
model.save_pretrained(formal_normative_sentence_generator_path)
tokenizer.save_pretrained(formal_normative_sentence_generator_path)
...
generated_sentence = loaded_tokenizer.decode(
